...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [2] = LAYOUT(
        ...
        _______,  _______,  KC_G,     KC_W,     KC_E,     _______,      _______,  _______,  _______,  _______,  _______,  _______,
        _______,  KC_LSFT,  KC_A,     KC_S,     KC_D,     KC_R,         _______,  _______,  _______,  _______,  _______,  _______,
        _______,  KC_LCTL,  KC_LALT,  KC_C,     KC_V,     KC_SPACE,     _______,  _______,  _______,  _______,  _______,  _______,
                                                TO(0),    KC_SPACE,     _______,  _______
    ),
    [3] = LAYOUT(
        _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______, _______, _______,  _______,  _______,
        _______,  _______,  _______,  KC_W,     _______,  _______,      _______,  _______, _______, _______,  _______,  _______,
        _______,  KC_LSFT,  KC_A,     KC_S,     KC_D,     _______,      _______,  _______, _______, _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,      _______,  _______, _______, _______,  _______,  _______,
                                                TO(0),    KC_SPACE,     _______,  _______
    )
};
